        ...
        <div class="table-responsive">
          <table class="table" id="table1">
            ...
            <tbody>
              <?php
              $no = 1;
              $query = mysqli_query($koneksi, "select * from user where level='pembeli'");
              ...
              ?>
                <tr>
                  ...
                  <td><a href="resetpassword.php?email=<?php echo $a['email']; ?>" onclick="return confirm('Yakin mereset password?')"><i class="fa-solid fa-key"></i></a></td>
                  <td><a href="?page=ubahpembeli&&email=<?php echo $a['email']; ?>"><i class="fa-solid fa-edit"></i></a></a> |
                    <a href="hapuspembeli.php?email=<?php echo $a['email']; ?>" onclick="return confirm('Yakin menghapus data ini?')"><i class="fa-solid fa-trash"></i></a>
                  </td>
                </tr>
              <?php } ?>
            </tbody>
